...
draft = false
summary = "<p>SolarBank Corporation, a renewable energy project developer, will release its financial results for the quarter ended March 31, 2025, and host a webinar to discuss its performance. The company focuses on distributed and community solar projects in Canada and the USA, selling electricity to various off-takers. SolarBank has a potential development pipeline of over one gigawatt and has developed projects with a combined capacity of over 100 megawatts built.</p>"
